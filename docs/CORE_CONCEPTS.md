...
- **Commit-with-imperfect-info tension** is intentional: you see archetype + difficulty + reward magnitude, not specific scenarios. **Scouting** (a cunning-hero action) can reveal 1–2 scenario hints before commit — a distinct use of social/scout heroes.
