...
4. [VISION.md](VISION.md) — One-page pitch, design pillars, non-goals.
...
5. [PROBLEM_AND_INHERITANCE.md](PROBLEM_AND_INHERITANCE.md) — Why Airaider exists as a remake; what is kept from AI Stronghold; what is replaced.
6. [GAMEPLAY_LOOP.md](GAMEPLAY_LOOP.md) — Macro (camp day cycle) and micro (raid) loops.
7. [CORE_CONCEPTS.md](CORE_CONCEPTS.md) — The old single-file synthesis. Predates the 200-day sim. Read `CANONICAL_DESIGN.md` instead.
8. [RAID_DESIGN.md](RAID_DESIGN.md) — Narrated Pool (superseded by Sultan-coin), leads, arcs, equipment principles.
9. [HEROES_AND_GROWTH.md](HEROES_AND_GROWTH.md) — "Heroes" (terminology superseded by "mercenaries"), early tag PoE-tier model, equipment.
10. [FORT_AND_PRESTIGE.md](FORT_AND_PRESTIGE.md) — 2D side-view cross-section fort, RoomTypes, adjacency, prestige formula.
11. [PROGRESSION_AND_PAYOFF.md](PROGRESSION_AND_PAYOFF.md) — Dopamine loop, reward economy, progression triangle.
