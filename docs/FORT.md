...
- **Regions (§13):** Forests (elf, **L1–8**) → City (human, **L6–16**) → Coast (lizardman, **L12–22**) → Highlands (wolfman, **L18–28**); Underdeep (no faction, **L24–34**, optional branch); the Outskirts (off-map, **L40→50**).
