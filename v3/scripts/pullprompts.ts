...
// ── P46: a dealt VOICE marker on a minority of cards. Blind judge C: 'no card here has an aside,
//        a joke, or a narrator with a view.' Measured on the 376 job-like reference rites the real
//        rates are: question 13%, em-dash aside 21%, explicit narrator aside 6% — so the judge's
//        'nearly every card' was an overstatement, and forcing it on every card would stamp.
//        Dealt by the engine because a bare permission reads as prohibition (PROMPT_RULES §10).
const P46 = `You write the card for ONE job in a dark-fantasy mercenary game.
...
- KEYWORDS: sparks for the world. Take ONE, or none. Two of them forced together make a card nobody can follow.
- intake: how word reached the fort. Never state it — the boss knows a card came from somewhere.
- voice: present on a minority of cards only. "question" — end on a real question the situation raises, not a rhetorical flourish. "aside" — one half-clause where the teller lets an opinion slip (of course, naturally, after all). "dash" — set one clause off with a dash to hold it apart. When this field is absent, write plainly and add none of these.
- gravity: the CEILING on this card's length, and it is a hard ceiling, not a target. A small everyday job: NO MORE THAN 25 WORDS, and one sentence is a perfectly good card. A serious matter: no more than 35. A grave affair: no more than 45. Coming in under is always better than reaching it.
- ask: what the person bringing this job wants done. Say it in your own words; never call them "the client".
- seen: one thing about them or the place that can be SEEN. Set it down as a plain fact in its own right. Join it to what came before ONLY if the join is really true — a fact that merely happens to be interesting is not a reason, and welding it on with a because that does not hold breaks the sentence. Standing alone as a short sentence is usually better. Do not explain what it means; the reader works that out. Never write that someone "will not say" or that "no one can say".
...
// ── P47: P46 + 'speech' in the dealt voice pool. Both blind judges asked for direct speech on
//        EVERY card; measured on the 376 job-like reference rites it is 5%. Followed at the real
//        rate rather than as stated — their instinct was right, their frequency was not.
const P47 = `You write the card for ONE job in a dark-fantasy mercenary game.
...
- KEYWORDS: sparks for the world. Take ONE, or none. Two of them forced together make a card nobody can follow.
- intake: how word reached the fort. Never state it — the boss knows a card came from somewhere.
- voice: present on a minority of cards only. "question" — end on a real question the situation raises, not a rhetorical flourish. "aside" — one half-clause where the teller lets an opinion slip (of course, naturally, after all). "dash" — set one clause off with a dash to hold it apart. "speech" — give the person asking ONE short line in their own words, in their own diction, and let it carry the ask. When this field is absent, write plainly and add none of these.
- gravity: the CEILING on this card's length, and it is a hard ceiling, not a target. A small everyday job: NO MORE THAN 25 WORDS, and one sentence is a perfectly good card. A serious matter: no more than 35. A grave affair: no more than 45. Coming in under is always better than reaching it.
- ask: what the person bringing this job wants done. Say it in your own words; never call them "the client".
- seen: one thing about them or the place that can be SEEN. Set it down as a plain fact in its own right. Join it to what came before ONLY if the join is really true — a fact that merely happens to be interesting is not a reason, and welding it on with a because that does not hold breaks the sentence. Standing alone as a short sentence is usually better. Do not explain what it means; the reader works that out. Never write that someone "will not say" or that "no one can say".
...
// ── P54: the synthesis blind judging pointed to. Variety comes from varying the VERB (the ask),
//        not the props — noun-atoms were merely decorated (13/16 vs 1/16). But ask and tell cannot
//        be DECOUPLED: a tell is a fact that undercuts THAT request, and decoupling produced
//        non-sequiturs. So the PAIR is kept and a SHAPE is added as an orthogonal third dimension.
const P54 = `You write the card for ONE job in a dark-fantasy mercenary game.
...
- voice: present on a minority of cards only. "question" — end on a real question the situation raises, not a rhetorical flourish. "aside" — one half-clause where the teller lets an opinion slip (of course, naturally, after all). "dash" — set one clause off with a dash to hold it apart. "speech" — give the person asking ONE short line in their own words, in their own diction, and let it carry the ask. When this field is absent, write plainly and add none of these.
- gravity: the CEILING on this card's length, and it is a hard ceiling, not a target. A small everyday job: NO MORE THAN 25 WORDS, and one sentence is a perfectly good card. A serious matter: no more than 35. A grave affair: no more than 45. Coming in under is always better than reaching it.
- shape: the TURN this story takes. Invent the situation so this is true of it; never state it on the card — the reader should feel it without being told.
- ask: what the person bringing this job wants done. Say it in your own words; never call them "the client".
- seen: one thing about them or the place that can be SEEN. Set it down as a plain fact in its own right. Join it to what came before ONLY if the join is really true — a fact that merely happens to be interesting is not a reason, and welding it on with a because that does not hold breaks the sentence. Standing alone as a short sentence is usually better. Do not explain what it means; the reader works that out. Never write that someone "will not say" or that "no one can say".
...
export const VARIANTS: Record<string, string> = { P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20, P21, P22, P23, P24, P25, P26, P30, P31, P32, P33, P34, P35, P36, P37, P38, P39, P40, P41, P42, P43, P44, P45, P46, P47, P54 };
