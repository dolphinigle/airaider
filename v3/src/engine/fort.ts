...
export const ROOM_TYPES: RoomType[] = [
  ...
  // functional comfort
  RT('infirmary', 'Infirmary', { species: 'comfort', benefit: 'heal', archetype: 'minor', ghTier: 1, themeHints: ['heal', 'nature'] }),
  ...
  RT('dining-hall', 'Dining hall', { species: 'comfort', benefit: 'prestige', archetype: 'std', ghTier: 1, themeHints: ['food', 'gregarious'], mates: ['kitchen'] }),
  RT('kitchen', 'Kitchen', { species: 'comfort', benefit: 'prestige', archetype: 'std', ghTier: 1, themeHints: ['food'], mates: ['dining-hall'] }),
  RT('garden', 'Garden', { species: 'comfort', benefit: 'prestige', archetype: 'minor', ghTier: 1, themeHints: ['nature', 'decoration'] }),
  RT('smithy', 'Smithy', { species: 'comfort', benefit: 'prestige', archetype: 'std', ghTier: 3, themeHints: ['craft', 'melee-weapon'], mates: ['hall-of-arms'] }),
  RT('gallery', 'Gallery', { species: 'comfort', benefit: 'prestige', archetype: 'std', ghTier: 2, themeHints: ['decoration', 'r-beautiful'] }),
  RT('trophy-room', 'Trophy room', { species: 'comfort', benefit: 'prestige', archetype: 'std', ghTier: 2, themeHints: ['curio', 'famous'] }),
  ...
  RT('shrine', 'Shrine', { species: 'comfort', benefit: 'prestige', archetype: 'std', ghTier: 3, themeHints: ['priest', 'decoration'] }),
  RT('music-hall', 'Music hall', { species: 'comfort', benefit: 'prestige', archetype: 'std', ghTier: 4, themeHints: ['performance', 'entertainer'] }),
  RT('menagerie', 'Menagerie', { species: 'comfort', benefit: 'prestige', archetype: 'std', ghTier: 4, themeHints: ['nature', 'curio'] }),
  ...
  RT('bathhouse', 'Bathhouse', { species: 'comfort', benefit: 'prestige', archetype: 'std', ghTier: 6, themeHints: ['beautiful', 'decoration'] }),
  RT('brewery', 'Brewery', { species: 'comfort', benefit: 'prestige', archetype: 'std', ghTier: 6, themeHints: ['food', 'craft'], mates: ['feast-hall'] }),
  RT('stables', 'Stables', { species: 'comfort', benefit: 'prestige', archetype: 'std', ghTier: 6, themeHints: ['nature', 'hunter'] }),
