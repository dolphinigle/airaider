  ...
  return {
    ...
    async genesis(input: GenesisInput): Promise<GenesisOut> {
      ...
      const system = [
        ...
        '- newPlaces: freely named — but never sharing the first syllable of any word of the landmark or of a place this message names (a coined twin-stem reads as the same place misspelled). Each blurb = ONE plain sentence, complete in itself, under about fifteen words.',
