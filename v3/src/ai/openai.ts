...
function oneOffSystem(input: QuestWriteInput): string {
  return [
    ...
    '- rarity: sets card size (see situation). level: the weight-class of the work — high level means matters worthy of veterans. slotCount: how many soldiers.',
