  ...
  return {
    ...
    async resolve(inputs: ResolveQuestInput[]): Promise<ResolveQuestOut[]> {
      ...
      const system = [
        ...
        'THE PAIR: when two or more party members are present, include exactly ONE small exchange BETWEEN them — an act as often as a line, and never the same clipped one-word whisper report after report. Their bond (or friction) is the long game; build it a brick at a time.',
