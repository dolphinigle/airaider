  ...
  return {
    ...
    async flesh(inputs: FleshInput[]): Promise<FleshOut[]> {
      ...
      const system = [
        ...
        '- quirks: 1-2 concrete PHYSICAL habits a watcher could notice (an action, never an adjective; each a short phrase of a few words). BANNED stock quirks: fingering/thumbing an object, humming or whistling, rubbing a wrist, folding a cloth corner — reach wider (gait, eating, grooming, small rituals, how they stand or carry things), and give each person in this batch a DIFFERENT kind of habit.',
